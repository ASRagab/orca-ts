...
The package is version `0.2.1`. Install the public npm package for normal project use:
...
```bash
ORCA_VERSION=0.2.1 ORCA_INSTALL_DIR="$HOME/.local/bin" \
  bash <(curl -fsSL https://github.com/ASRagab/orca-ts/releases/download/v0.2.1/install.sh)
```
