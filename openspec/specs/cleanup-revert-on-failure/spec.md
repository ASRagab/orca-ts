...
Define how `cleanupFile` restores file state when an agent call fails mid-edit, ensuring the working tree is never left dirty after a skipped cleanup attempt.
